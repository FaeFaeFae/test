...
/// <reference path="../hxpublic_v6/hxwww602page_common.min.js" />
...
var PDFViewerApplication = {
  ...
  setInitialView: function setInitialView(storedHash) {
    ...
    this.pdfViewer.currentPageNumber = this._GetInitialPageNumber();
  ...
  _GetInitialPageNumber:function _GetInitialPageNumber()
  {
      var strTargetPageNumber = HXWebDynamicPage.GetWebPageConfigDataValue("PDF_PAGE_NUMBER");
      if (HXWebJS.Core.IsStringNullOrEmpty(strTargetPageNumber)) strTargetPageNumber = '1';
      var intPageNumber = parseInt(strTargetPageNumber);
...
function webViewerPageChanging(evt) {
  ...
  // 投递消息给父窗口或者源窗口
  HXWebJS.EventManager.PostMessageToParentOrOpenerWin("hxsm_pdf_file_page_changed", page);
}
...
var DEFAULT_URL = '../pdfjs/demo.pdf';
;
...
function getViewerConfiguration() {
  return {
    ...
    defaultUrl: HXWebDynamicPage.GetWebPageConfigDataValue("PDF_FILE_URL") // added for customized url
  };
}
